...
## 核心特性
<img src="animation.gif" width="600" alt="动画演示">
### 实时动态
...
| :--- | :--- | :--- | :--- |
| **头发** | `front hair`, `back hair`, `side hair`, `mid hair`, `ahoge` | 前发, 后发, 前髪, 後ろ髪, 侧发, 中发, 呆毛 | 独立头壳跟随 + $v^3$ 发梢物理摆动；侧发/中发/呆毛各自独立物理链（渐弱摆/软摆/弹性摆） |
| **裙/腿/领结** | `bottomwear`, `legwear`, `neckwear` | 裙子, 裤子, 腿, 鞋, 领结, 领饰 | 裙摆 5 节体感物理、腿部 3 节硬质跟随、领结 5 节轻质摆动 |
