...
| :--- | :--- | :--- | :--- |
| **髪** | `front hair`, `back hair`, `side hair`, `mid hair`, `ahoge` | 前髪, 後ろ髪, 横髪, 中髪, アホ毛 | ヘッド追従ワープ + $v^3$ 先端物理；横髪・中間髪・アホ毛はそれぞれ独立物理チェーン |
| **スカート/脚/襟** | `bottomwear`, `legwear`, `neckwear` | スカート, ズボン, 脚, 靴, 襟 | 5節スカート揺れ・3節脚追従・5節襟揺れ |
