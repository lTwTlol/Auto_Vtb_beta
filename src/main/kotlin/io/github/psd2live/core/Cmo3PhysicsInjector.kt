...
internal object Cmo3PhysicsInjector {
	fun inject(root: CModelSource, parts: PhysicsGenerator.PhysicsParts, custom: List<RigPhysicsEdit> = emptyList(), tuning: PhysicsTuning = PhysicsTuning()): Int {
		...
		val rules = PhysicsGenerator.mergeCustomRules(PhysicsGenerator.validRules(parts, parameterById.keys, tuning), custom, parameterById.keys)
