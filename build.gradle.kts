...
compose.desktop {
	application {
		...
		nativeDistributions {
			...
			packageName = "Auto_Vtb"
			packageVersion = "0.6.0"
			description = "Auto_Vtb - Automated Live2D Rigging Pipeline"
			copyright = "© 2026 Auto_Vtb. Licensed under GPL-3.0."
			vendor = "Auto_Vtb"
...
afterEvaluate {
	...
	tasks.named("createDistributable").configure {
		doLast {
			val appDir = file("build/compose/binaries/main/app/Auto_Vtb/app")
			if (appDir.exists()) {
